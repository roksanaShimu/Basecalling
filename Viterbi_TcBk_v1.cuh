...
#ifndef VITERBI_TCBK_V1_CUH_
#define VITERBI_TCBK_V1_CUH_
...
__global__ void kernel(int32_t *devPtr_pm, int32_t *devPtr_log_pr, int32_t *alpha, uint16_t *beta, int32_t p_max, int32_t *d_amax, unsigned int *d_jmax, int32_t *d_mutex){
...
*/
	...
	kernel<<< number_of_blocks, threads_per_block >>>(devPtr_pm, devPtr_log_pr, dev_alpha, dev_beta, p_max, d_amax, d_jmax, d_mutex);
	cudaDeviceSynchronize();
